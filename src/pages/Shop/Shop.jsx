                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6 col-md-6 col-sm-6">
                                        <div className="shop__product__option__right">
                                            ...
                                            </select><div className="nice-select" tabIndex={0}><span className="current">Low To High</span><ul className="list"><li data-value className="option selected">Low To High</li><li data-value className="option">$0 - $55</li><li data-value className="option">$55 - $100</li></ul></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
